...
Мөн хоёр туршилтын үед хоёуланд нь error rate 0% байсан бөгөөд бүх request амжилттай хариу өгсөн. Иймээс delay нь серверийн найдвартай байдалд нөлөөлөөгүй ч response time болон нийт throughput-д шууд сөргөөр нөлөөлсөн гэж дүгнэж болно.
